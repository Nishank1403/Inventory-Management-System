...
class IMS:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Nishank Mhatre")
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Nishank Mhatre\nFor any Technical Issues Contact: 989885598",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
